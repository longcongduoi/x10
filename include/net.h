...
namespace x10
{
    namespace detail
    {
        ...
        // TODO: merge all global inline functions into a set of classes.
        ...
        inline uv_err_t from_ip4_addr(sockaddr_in* src, std::string& ip, int& port)
        {
            char dest[16];
        ...
        inline uv_err_t from_ip6_addr(sockaddr_in6* src, std::string& ip, int& port)
        {
            char dest[46];
